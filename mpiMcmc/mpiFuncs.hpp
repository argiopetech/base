...
double logPostStep(Chain &, const Model &, std::array<double, N_WD_MASS1> &, Cluster &, double, std::array<double, 2> &, const std::vector<int>&, std::array<double, FILTS>&, std::array<double, FILTS>&);
