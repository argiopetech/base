...
double scaledLogLike (int numFilts, const Star &pStar, double varScale, const std::array<double, FILTS>&, const std::array<double, FILTS>&);
double logPost1Star (const Star &, const Cluster &, const Model&, const std::array<double, FILTS>&, const std::array<double, FILTS>&);
double Phi (double x);
