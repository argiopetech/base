...
/*                postClusterStar = lambda       * margEvolveWithBinary (propClustA, systems.at(i), evoModels, settings.noBinaries)
                                + (1 - lambda) * margEvolveWithBinary (propClustB, systems.at(i), evoModels, settings.noBinaries);
*/
            }
            catch ( WDBoundsError &e )
            {
